...
public class L2E2_MoveState : MoveState
{
    private L2E2_Enemy enemy;
    public L2E2_MoveState(Entity entity, StateController stateController, string animBoolName, D_MoveState stateData, L2E2_Enemy enemy) : base(entity, stateController, animBoolName, stateData)
    {
        this.enemy = enemy;
    }
