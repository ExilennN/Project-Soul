...
public class L2E1_MoveState : MoveState
{
    private L2E1_Enemy enemy;
    public L2E1_MoveState(Entity entity, StateController stateController, string animBoolName, D_MoveState stateData, L2E1_Enemy enemy) : base(entity, stateController, animBoolName, stateData)
    {
        this.enemy = enemy;
    }
