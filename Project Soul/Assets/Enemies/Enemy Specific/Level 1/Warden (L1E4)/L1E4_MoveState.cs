...
public class L1E4_MoveState : MoveState
{
    private L1E4_Enemy enemy;
    public L1E4_MoveState(Entity entity, StateController stateController, string animBoolName, D_MoveState stateData, L1E4_Enemy enemy) : base(entity, stateController, animBoolName, stateData)
    {
        this.enemy = enemy;
    }
